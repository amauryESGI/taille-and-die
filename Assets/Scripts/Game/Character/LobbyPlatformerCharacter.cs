...
namespace Platformer.Character {
    public class LobbyPlatformerCharacter : MonoBehaviour {
        [SerializeField] private Animator _anim; // Reference to the player's animator component.
        [SerializeField] private float _speed = 10f; // The fastest the player can travel in the x axis.
        [SerializeField] private bool _grounded = false; // Whether or not the player is grounded.
